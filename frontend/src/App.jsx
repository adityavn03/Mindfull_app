...
function App() {
  ...
  const registerUser = async () => {
    try {
      const res = await fetch("https://mindfull-app.onrender.com/api/users/register", {
        method: "POST",
  ...
  const addHabit = async () => {
    ...
    try {
      const res = await fetch("https://mindfull-app.onrender.com/api/habits", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchHabits = async () => {
    if (!userId) return;
    try {
      const res = await fetch(`https://mindfull-app.onrender.com/api/habits/${userId}`);
      const data = await res.json();
      setHabits(data);
    } catch (error) {
  ...
  const toggleHabit = async (id) => {
    ...
    try {
      await fetch(`https://mindfull-app.onrender.com/api/habits/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const deleteHabit = async (id) => {
    ...
    try {
      await fetch(`https://mindfull-app.onrender.com/api/habits/${id}`, { method: "DELETE" });
    } catch (error) {
